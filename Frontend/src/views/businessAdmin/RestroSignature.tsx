              ...
              <div className="p-5">
                ...
                <div className="bg-stone-50 p-4 rounded-2xl border border-stone-200 mb-8">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-mono font-semibold text-stone-500">IND-SIG-{Math.floor(1000 + Math.random() * 9000)}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    onClick={() => {
                      const invoiceNum = 'IND-SIG-' + Math.floor(100000 + Math.random() * 900000);
                    ...
                    disabled={!paymentMethod || !customerName.trim() || !customerPhone.match(/^\d{10}$/) || checkoutPdrMutation.isPending}
