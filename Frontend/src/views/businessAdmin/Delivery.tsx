            ...
            >
               ...
               <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                     <div className="space-y-2">
                        ...
                        <input type="text" placeholder="e.g. John Doe" className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl font-semibold" />
                     </div>
                     <div className="space-y-2">
                        <label className="text-xs font-semibold text-slate-400 uppercase tracking-widest px-2">Phone</label>
                        <input type="tel" placeholder="+91 XXXX" className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl font-semibold" />
                     </div>
                  </div>
               ...
               <div className="flex gap-4 mt-10">
                  ...
                  <button 
                    ...
                    className="flex-[2] py-4 bg-brand-success text-white font-semibold rounded-2xl shadow-xl shadow-brand-success/20"
                  >
                    CONFIRM & CREATE
                  </button>
               </div>
