            ...
            <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-bold mt-1">Order #{(order as any).transactionId ? (order as any).transactionId : order._id.substring(order._id.length - 8).toUpperCase()}</p>
                </div>
              </div>
