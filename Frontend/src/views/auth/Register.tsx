...
export const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/auth/register/customer`, {
        method: 'POST',
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10 h-full max-h-[800px]">
        ...
        <div className="hidden lg:block space-y-6">
          <motion.div 
            ...
            className="inline-block relative cursor-pointer mb-6"
          >
